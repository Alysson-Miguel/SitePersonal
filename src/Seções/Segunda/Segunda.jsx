            ...
            <Row>
                ...
                <Col md={7} sm={12} className="d-flex align-items-right justify-content-right">
                    <aside className="Texto">
                        ...
                        <p style={{ fontWeight: 'bold' }}> Foi a partir dessas experiências que resolvi empenhar-me em adquirir os conhecimentos necessários para alcançar  resultados mais expressivos.
